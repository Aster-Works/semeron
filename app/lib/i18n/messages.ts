...
export const messages = {
  ...
  "groupsAdmin.delete": { ja: "削除", en: "Delete" },
  "groupsAdmin.deleteTitle": { ja: "グループを削除", en: "Delete group" },
  "groupsAdmin.deleteBody": {
    ja: "このグループを削除します。メンバー割り当ては外れます。祈祷課題などの履歴がある場合は削除できません。",
    en: "This will delete the group and remove member assignments. Groups with prayer history or other content cannot be deleted.",
  },
  "groupsAdmin.deleteConfirm": { ja: "削除する", en: "Delete" },
  "groupsAdmin.deleteHasContent": {
    ja: "このグループには祈祷課題などの履歴があるため削除できません。アーカイブしてください。",
    en: "This group has prayer history or other content, so it cannot be deleted. Archive it instead.",
  },
  "groupsAdmin.deleteError": {
    ja: "グループを削除できませんでした。",
    en: "Could not delete this group.",
  },
  ...
  "settings.churchNameHint": {
    ja: "教会の主言語で表示される名前です。",
    en: "The name shown in the church's primary language.",
  },
  ...
  "settings.morningTimeHint": {
    ja: "予約デボーションの公開時刻と朝の通知に使われます。",
    en: "Used for scheduled devotion publishing and morning notifications.",
  },
  "settings.basicsSaved": { ja: "保存しました。", en: "Saved." },
  "settings.basicsError": { ja: "保存できませんでした。", en: "Could not save." },
